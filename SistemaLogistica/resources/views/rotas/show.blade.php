...
@section('content')
    <div class="container">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-success  text-white"
                style="background: linear-gradient(90deg, #264653);>
    ...
    <script>
        ...
        // Centraliza o mapa entre os pontos
        ...
        // Cria marcador com legenda estilizada
    ...
    `;
        createMarkerWithFixedLabel(veiculo, null, "{{ $data->veiculo->placa }} - {{ $data->motorista->usuario->nome }}",
            truckSVG);
