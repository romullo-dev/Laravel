      ...
      <div class="modal-body">
        <div class="row g-3">
          ...
          <div class="col-md-2">
            ...
            <input type="number" name="ano" id="ano" class="form-control" min="1900" max="2099" required>
          </div>
          ...
          <!-- Status -->
          <div class="col-md-3">
            <label class="form-label" for="status_veiculo"><i class="bi bi-toggle-on me-1"></i>Status</label>
          ...
          <!-- Modelo -->
          <div class="col-md-6">
            <label class="form-label" for="id_modelo_veiculo"><i class="bi bi-truck-front-fill me-1"></i>Modelo (ID)</label>
            <input type="number" name="id_modelo_veiculo" id="id_modelo_veiculo" class="form-control" required>
          </div>
          ...
          <!-- Tara -->
          <div class="col-md-3">
            <label class="form-label" for="tara_kg"><i class="bi bi-box-seam-fill me-1"></i>Tara (kg)</label>
            <input type="number" name="tara_kg" id="tara_kg" class="form-control" step="0.01" required>
          </div>

          <!-- PBT -->
          <div class="col-md-3">
            <label class="form-label" for="pbt_kg"><i class="bi bi-truck me-1"></i>PBT (kg)</label>
            <input type="number" name="pbt_kg" id="pbt_kg" class="form-control" step="0.01" required>
          </div>

          <!-- Observações -->
          <div class="col-md-12">
            <label class="form-label" for="observacoes"><i class="bi bi-pencil-square me-1"></i>Observações</label>
